...
Most farms also include a **[detection](concepts/detection-methods.md)** module that detects growth and triggers the farm, but this is optional.^[raw/articles/gtmc-tree-farm-basics.md]
