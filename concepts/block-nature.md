...
sources: [raw/articles/gltmc-block-mechanics.md]
---

# Block Nature (Block vs BlockState)

In source code, `Block` and `BlockState` are distinct concepts. This chapter frames block-state design, the full placement/breaking process, and how blocks connect to chunk mechanics and the update system.^[raw/articles/gltmc-block-mechanics.md]
