...
> Content catalog (OKF progressive disclosure). An agent starts here, then follows
> `[concept](concepts/x.md)` links to traverse the knowledge graph.
...
- [Rails](concepts/rails.md) — Powered/Activator/Detector NC-update order, diode connectivity
...
gtmc-rails.md, gtmc-rail-budding.md
